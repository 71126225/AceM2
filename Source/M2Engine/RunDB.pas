...
var
  ...
  boShow: Boolean;
resourcestring
  sIDServerConnected = 'Database Server (%s:%d) Connected...';
  sIDServerDisconnect = 'Database Server (%s:%d) Disconnected...';
begin
  try
    s := INVALID_SOCKET;
...
var
  ...
  boExit: Boolean;
resourcestring
  sLoadDBTimeOut = '[RunDB] Character data read out... [';
  sSaveDBTimeOut = '[RunDB] Character data stored... [';
begin
  boLoadDBOK := False;
  Result := False;
  boExit := False;
