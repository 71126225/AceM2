...
begin
  ...
  EditZenMonRate.Hint :=
    'brush strange rate, divided by 10 for the actual magnification ratio (set to 10, compared with 1:1), this ratio to something and file settings prevail, the larger the number, the smaller the number of brush strange. ';
  ...
  EditProcessMonsterInterval.Hint := 'Monster idle interval, the larger the number, the monster, the slower response.';
end;
