...
begin
  ...
  RefGameMasterCmd(@g_GameCommand.MAPMOVE,
    '@' + g_GameCommand.MAPMOVE.sCmd + '  <Old map no> <New map no>',
                   'Teleport All players in old map to new map');
  ...
  RefGameMasterCmd(@g_GameCommand.Map,
    ...
    'Displays the current map filename and size');
  ...
  RefGameMasterCmd(@g_GameCommand.CHANGEJOB,
    ...
    ' <Username> <Job(Warrior, Wizard, Taoist, Assassin, Archer)>',
  ...
  RefGameMasterCmd(@g_GameCommand.TRAINING,
    ...
    '  <Username> <Skill name> <Skill level(0-3)>',
  ...
  RefGameMasterCmd(@g_GameCommand.CLEARMON,
    ...
    '<Map(* for all)> <Mob name(* for all)> <Drop items(0,1)>',
  ...
  RefGameMasterCmd(@g_GameCommand.STARTQUEST,
    ...
    'Start asking questions feature, Skips problem game windows');
  ...
  RefGameMasterCmd(@g_GameCommand.DELDENYIPLOGON,
    '@' + g_GameCommand.DELDENYIPLOGON.sCmd + ' Un-Block a user from logging in from a specific IP address','');
  ...
  RefGameMasterCmd(@g_GameCommand.DENYACCOUNTLOGON,
    ...
    '<AccountID> <Disable/Enable(0,1)>',
          'Block a user from logging in from a specific account');

  RefGameMasterCmd(@g_GameCommand.DELDENYACCOUNTLOGON,
    '@' + g_GameCommand.DELDENYACCOUNTLOGON.sCmd + 'Un-Block a user from logging in from a specific account','');
  ...
  RefGameMasterCmd(@g_GameCommand.DENYCHARNAMELOGON,
    ...
    ' <Username> <Disable/Enable(0,1)>',
          'Block a user from logging in from a specific player name');

  RefGameMasterCmd(@g_GameCommand.DELDENYCHARNAMELOGON,
    '@' + g_GameCommand.DELDENYCHARNAMELOGON.sCmd + ' Un-Block a user from logging in from a specific player name','');
...
begin
  ...
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Set the specified flag of a user(ON/OFF)');
  ...
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Reload Robot scripts');

  GameCmd := @g_GameCommand.RELOADMONITEMS;
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Reload mon drop files');
  ...
  GameCmd := @g_GameCommand.RELOADBANNEDAPPS;
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Reload Banned apps');
  ...
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Set max online users count');

  GameCmd := @g_GameCommand.CHGZENFASTSTEP;
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd,
    'Set monster action speed');
...
begin
  ...
  CommandConf.WriteString('Command', 'RELOADBANNEDAPPS',
    g_GameCommand.RELOADBANNEDAPPS.sCmd);
