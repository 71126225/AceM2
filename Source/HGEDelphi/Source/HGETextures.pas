...
type
  ...
  public
    ...
    procedure Draw(X, Y: Integer; Source: TDXTexture; Color: Cardinal; BlendMode: Integer); overload;
...
procedure TDXTexture.Draw(X, Y: Integer; Source: TDXTexture; Color: Cardinal; BlendMode: Integer);
begin
  if source = nil then exit;
  if FDrawCanvas <> nil then
    TDXCanvas(FDrawCanvas).Draw(Source, X, Y, BlendMode, Color);
end;
