...
begin
  ...
  Result := Result and (FileExists(sDir + 'data\UI3.wil') or FileExists(sDir + 'data\UI3.wzl'));
  Result := Result and (FileExists(sDir + 'data\ChrSel2.wil') or FileExists(sDir + 'data\ChrSel2.wzl'));
  Result := Result and (FileExists(sDir + 'data\Effect_Login.wil') or FileExists(sDir + 'data\Effect_Login.wzl'));
  Result := Result and (FileExists(sDir + 'data\hum_ck.wil') or FileExists(sDir + 'data\hum_ck.wzl'));
  Result := Result and (FileExists(sDir + 'data\hum_gjs.wil') or FileExists(sDir + 'data\hum_gjs.wzl'));
