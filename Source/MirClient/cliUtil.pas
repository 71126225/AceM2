...
uses
  Windows, WIL, HGE, HGETextures, HGEImages, Graphics;
...
begin
  ...
  else if blendmode = 2 then
    dsuf.Draw(x, y, ssuf.ClientRect, ssuf, BLEND_SrcColorAdd)
  else
...
begin
  if (ssuf = nil) or (dsuf = nil) then exit;
    ...
    ceGrayScale: begin
        ...
        if ssuf.Lock(lfReadOnly, SourceAccess) then begin
          ...
          if TargetTexture <> nil then
            Dsuf.Draw(x, y, TargetTexture.ClientRect, TargetTexture, clWhite or nColor, DrawFx); //best i'm gonna get out of it tbh
        end;
      end;
    ceBright: begin
//      DSuf.Draw(x, y, ssuf.ClientRect, ssuf, clwhite or nColor, fxanti);
//      Dsuf.Draw(x, y, ssuf.ClientRect, ssuf, $FFC0C0C0, fxBlend);
//      DSuf.Draw(x, y, ssuf.ClientRect, ssuf, $FFC0C0C0, fxanti);
    ...
    ceTeal: Dsuf.Draw(x, y, ssuf.ClientRect, ssuf, clAqua or nColor, DrawFx);
  end;
end;
