...
begin
  try
    MainOutMessage('Select Gate Starting...', 0);
    ...
    MainOutMessage('SelectGate started successfully', 0);
...
var
  ...
  //IPList: TList;
begin
  MainOutMessage('Stopping Connections...', 3);
...
begin
  if Application.MessageBox('Are you sure you want to close the gate?',
                            'Warning!',
