...
begin
  ...
  Try
    LogMonster.Lines.Add('Preparing for conversion Of Monster.DB...');
    BtnMonster.Enabled := False;
    CheckBoxMonster.Enabled := False;
    Try
      LogMonster.Lines.Add('Generating Monster_New.DB...');
      ...
      Try
        ...
        BarMonster.Min := 0;
        LogMonster.Lines.Add('Converting data...');
      ...
      Finally
        Query.Close;
      End;
      LogMonster.Lines.Add('Conversion Complete...');
    Finally
...
begin
  Try
    LogStdItems.Lines.Add('Preparing for conversion StdItems.DB...');
    BtnStdItems.Enabled := False;
    CheckBoxStdItems.Enabled := False;
    CBStdItems.Enabled := False;
    Try
      LogStdItems.Lines.Add('Generating StdItems_New.DB...');
      ...
      Try
        ...
        BarStdItems.Min := 0;
        LogStdItems.Lines.Add('Converting data...');
        for i := 0 to Query.RecordCount - 1 do begin
      ...
      Finally
        Query.Close;
      End;
      LogStdItems.Lines.Add('Conversion Complete...');
    Finally
