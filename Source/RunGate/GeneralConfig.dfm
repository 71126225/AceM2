object frmGeneralConfig: TfrmGeneralConfig
  ...
  object GroupBoxInfo: TGroupBox
    ...
    object EditTitle: TEdit
      ...
      Height = 20
      Hint = 
        'This name is used only to display the name that appears on the p' +
        'rogram title'#13#10'Temporarily not for other purposes.'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 0
    ...
    object TrackBarLogLevel: TTrackBar
      ...
      Width = 145
      Height = 25
      Hint = 'The program running log shows the level of detail.'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 1
    end
    object ComboBoxShowBite: TComboBox
      ...
      Height = 20
      Hint = 
        'The program'#39's main interface displayed on the monitoring data fl' +
        'ow display unit.'
