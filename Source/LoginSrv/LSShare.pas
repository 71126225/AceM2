...
const
  ...
  sSQLInstance = 'SQLInstance';
  sSQLLoginServer = 'SQLLoginServer';
  nDisableClientCreation = 'DisableClientCreation';
  sAccountURL = 'AccountCreationURL';
  sPasswordURL = 'ChangePasswordURL';
...
type
  ...
  TConfig = record
    ...
    sSQLInstance: String;
    sSQLLoginServer: String;
    nDisableClientCreation: Integer;
    sAccountURL: String;
    sPasswordURL: String;
  end;
  pTConfig = ^TConfig;
...
var
  g_Config: TConfig = (
    ...
    sSQLInstance: '(local)';
    sSQLLoginServer: 'Mir2_LoginServer';
    nDisableClientCreation: 0;
    sAccountURL: 'http://www.acem2.com';
    sPasswordURL: 'http://www.acem2.com'
    );
