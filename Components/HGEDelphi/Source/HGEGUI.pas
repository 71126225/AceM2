...
type
  ...
  private
    ...
    FOnGridRightSelect: TOnGridSelect;
  ...
  published
    ...
    property OnGridRightSelect: TOnGridSelect read FOnGridRightSelect write FOnGridRightSelect;
  ...
  public
    ...
    function MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer;boAuction: boolean = False): Boolean;
    function MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer;boAuction: boolean = False): Boolean;
    function DblClick(X, Y: integer; boAuction: boolean = False): Boolean;
    function Click(X, Y: integer): Boolean;
    function EscClose(): Boolean;
    procedure DirectPaint(dsurface: TDirectDrawSurface);
    function InputBoxOpen(): Boolean;
  end;
...
begin
  Result := FALSE;
  if (mbLeft = Button) or ((mbRight = Button) and Assigned(FOnGridRightSelect)) then begin
  ...
  if mbright = Button then begin
    if GetColRow(X, Y, acol, arow) then begin
      if (FSelectCell.X = acol) and (FSelectCell.Y = arow) then begin
        Col := acol;
        Row := arow;
        if Assigned(FOnGridRightSelect) then begin
          FOnGridRightSelect(Self, X, Y, acol, arow, Shift);
          Result := TRUE;
        end;
      end;
...
function TDWinManager.InputBoxOpen: Boolean;
begin
  Result := False;
  if KeyControl <> nil then begin
...
function TDWinManager.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y:
  Integer;boAuction: boolean = False): Boolean;
var
  i: integer;
  MDWindow: TDModalWindow;
begin
...
function TDWinManager.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer;boAuction: boolean = False): Boolean;
var
  i: integer;
  MDWindow: TDModalWindow;
begin
...
function TDWinManager.DblClick(X, Y: integer;boAuction: boolean = False): Boolean;
var
  i: integer;
  MDWindow: TDModalWindow;
begin
