...
uses
  Windows, Graphics, DirectXGraphics, HGEBase, HGE, HGETextures, HGEFonts, HGEImages;
...
type
  ...
  private
    ...
    procedure SetPattern2(Texture: ITexture; PatternIndex: Integer);
  ...
  public
    ...
    procedure DrawEx(Texture: iTexture; PatternIndex: Integer; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single;
    ...
    procedure DrawEx(Texture: iTexture; PatternIndex: Integer; X, Y, Scale: Single;
...
procedure TDXCanvas.SetPattern2(Texture: ITexture; PatternIndex: Integer);
var
  TexX1, TexY1, TexX2, TexY2: Single;
...
Procedure TDXCanvas.DrawEx(Texture: iTexture; PatternIndex: Integer; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single;
...
begin
  //image:= Texture.Image;
  SetPattern2(Texture, PatternIndex);
...
procedure TDXCanvas.DrawEx(Texture: iTexture; PatternIndex: Integer; X, Y, CenterX, CenterY, ScaleX, ScaleY: Single; MirrorX, MirrorY: Boolean; Color: Cardinal; BlendMode: Integer);
var
  TempX1, TempY1, TempX2, TempY2: Single;
  //image: Itexture;
begin
...
procedure TDXCanvas.DrawEx(Texture: ITexture; PatternIndex: Integer; X: Single; Y: Single; Scale: Single; DoCenter: Boolean; Color: Cardinal; BlendMode: Integer);
var
...
begin
  ...
  DrawEx(Texture, PatternIndex, X, Y, CenterPosX, CenterPosY, Scale, Scale,
